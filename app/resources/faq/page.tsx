...
const groups: Group[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: <>We cover Tampa Bay across Hillsborough, Pasco, and Pinellas counties, including Lutz, Land O Lakes, Wesley Chapel, Palm Harbor, Oldsmar, and Tampa, plus the towns in between. See our <A href={ROUTES.serviceAreas}>service areas</A> page.</>,
        plain: "We cover Tampa Bay across Hillsborough, Pasco, and Pinellas counties, including Lutz, Land O Lakes, Wesley Chapel, Palm Harbor, Oldsmar, and Tampa, plus the towns in between.",
      },
      {
