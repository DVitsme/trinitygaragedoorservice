...
const data: CityAreaData = {
  ...
  closingLead:
    "Call (813) 279-6785 for same day garage door service in Palm Harbor, or request service or a free estimate online. Family owned, licensed and insured under FL GD13010 and GDI-09484, serving Tampa Bay since 2007.",
};
