...
export const metadata: Metadata = {
  ...
  description:
    "Garage door service and new door installation across Land O' Lakes, FL. Family owned, same day repairs, free estimates, phones answered till 9pm. Call (813) 279-6785.",
...
const data: CityAreaData = {
  ...
  closingLead:
    "Call (813) 279-6785 for same day garage door service in Land O' Lakes, or request service or a free estimate online. Family owned, licensed and insured under FL GD13010 and GDI-09484, serving Tampa Bay since 2007.",
};
