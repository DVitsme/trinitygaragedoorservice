...
const otherWays: { icon: ReactNode; title: string; body: string; href: string; foot: ReactNode }[] = [
  ...
  { icon: ico(26, (<><path d="M9 12l2 2 4-4" /><circle cx="12" cy="12" r="9" /></>)), title: "Request A Free Estimate", body: "Weighing a new door or a bigger job? We'll come take a look and give you an honest number, no pressure.", href: ROUTES.estimate, foot: "Request an estimate" },
