...
**Living document.** Last updated: 2026-08-10. Deeper detail: `PRE-LAUNCH-PUNCHLIST.md`,
...
| 6b | 🔴 **URGENT NOW. How far south do you actually go?** | Simone named **"some of the areas in the Sarasota area"** as served. Sarasota and Manatee are **not** in the 130 zip Housecall Pro zone the whole site is built from. **This stopped being theoretical on 2026-08-10:** we published a **North Manatee** page covering **Palmetto, Parrish and Ellenton** (zips 34221, 34219, 34222), and added those three zips to the "are you in our area?" checker. That is now a public promise. It is roughly **an hour each way** from Lutz. **Two things to confirm: (1) do you want that work, and (2) do you want Bradenton and Lakewood Ranch too, or is the Manatee River the line?** We deliberately stopped at the river. Jason offered to review a town list, so this is that list. | ☐ |
| 6c | 🆕 🔴 **Does your licence cover Manatee County?** | Straight follow on from **5b**, and the reason 5b now matters more. **GD13010 is a Hillsborough county licence and GDI-09484 is Pasco.** If those are **county** licences rather than Florida **state** ones, they may not cover work in Manatee, and every page on the site carries "Licensed · Bonded · Insured · FL GD13010 / GDI-09484" in the bar under the header. **We left the licence numbers off the North Manatee page copy on purpose**, but that shared bar still shows them. **Do not sell Manatee work until Jason answers this.** Manatee also requires a **permit** for a garage door replacement, tied to a Florida Product Approval rated for the local wind speed. | ☐ |
